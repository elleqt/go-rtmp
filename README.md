...
See also [server_demo](https://github.com/yutopp/go-rtmp/tree/master/example/server_demo)
and [client_demo](https://github.com/yutopp/go-rtmp/blob/master/example/client_demo/main.go).
